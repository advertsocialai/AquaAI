...
export default function ExpertPage() {
  ...
  useEffect(() => { document.title = t('expertPage.docTitle'); }, [t]);

  return (
    <div className="min-h-screen bg-white text-neutral-900">
      <MobileTopBar title={t('expertPage.topBarTitle')} />
      ...
      <main className="max-w-md mx-auto px-6 pt-8 pb-28">
        ...
        <div className="space-y-4">
          <ExpertRow to="/contact?reason=tickets" icon={Ticket} label={t('expertPage.allTickets')} />
          <ExpertRow to="/knowledge" icon={FileText} label={t('expertPage.viewPrescription')} />
        </div>
      </main>
