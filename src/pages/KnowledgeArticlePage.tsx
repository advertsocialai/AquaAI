...
const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      { kind: 'p', text: 'When the pre-dawn DO meter reads below 3.5 mg/L, do not wait for the test kit. Turn on every aerator at full power, exchange 30% water immediately if salinity allows, and dose emergency oxygen if available. Aqua AI\'s pond advisory module will push a push notification within 5 minutes of the first sensor reading.' },
      ...
      { kind: 'p', text: 'If body weight is above 18 g and the 7-day NH3 trend is climbing past 1.5 mg/L, partial harvest is usually the right call. Aqua AI\'s harvest-timing recommender combines current body weight, mandi prices, and outbreak risk to flag the optimal window.' },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: 'ul', items: [
        ...
        'Photo the trays daily — Aqua AI\'s checktray module reads the score automatically.',
      ] },
    ],
  },
  {
    ...
    body: [
      ...
      { kind: 'ul', items: [
        ...
        'Aqua AI QC certificate with composite score ≥ 80.',
  ...
  },
  {
    ...
    body: [
      { kind: 'p', text: 'PCR labs are the gold standard for EHP, but turn-around time is 36-72 hours. In a 120-day cycle that delay is the difference between salvaging a crop and losing it. The Aqua AI EHP detector closes that gap to 30 seconds with sensitivity > 92% vs PCR.' },
    ],
  },
  {
...
export default function KnowledgeArticlePage() {
  ...
  useEffect(() => {
    document.title = article ? `${article.title} — Aqua AI` : 'Article not found — Aqua AI';
  }, [article]);
