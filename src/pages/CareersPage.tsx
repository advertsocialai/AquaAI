...
const PERKS = [
  { icon: Clock,     title: 'Flexible Hours',       desc: 'Aqua Rudra offers flexible hours, empowering employees to tailor their work schedules for optimal work-life balance, making it easier to manage personal and professional commitments.' },
  { icon: Wallet,    title: 'Competitive Salaries', desc: 'Aqua Rudra values its employees by providing competitive salaries, recognizing their contributions and ensuring fair compensation within the aquaculture sector — supporting financial well-being and job satisfaction.' },
  { icon: TrendingUp,title: 'Career Growth',        desc: 'At Aqua Rudra, we foster career growth through continuous learning, mentoring and opportunities for advancement, enabling our team to achieve their professional aspirations within the dynamic aquaculture industry.' },
  { icon: Smile,     title: 'Fun Environment',      desc: 'Aqua Rudra cultivates a dynamic and enjoyable workplace culture, encouraging a sense of unity and providing enjoyable experiences that boost job satisfaction and employee well-being.' },
  { icon: Heart,     title: 'Meaningful Projects',  desc: 'Aqua Rudra offers employees the chance to engage in meaningful projects that impact the aquaculture industry, fostering a sense of purpose and contribution to sustainable farming practices.' },
  { icon: Lightbulb, title: 'Innovative Culture',   desc: 'Aqua Rudra nurtures an innovative culture that fuels creative thinking and encourages the development of cutting-edge solutions, fostering a dynamic environment that drives progress within aquaculture.' },
...
const WHY = [
  ...
  { icon: Target,   title: 'Impact',      body: "At Aqua Rudra, your work directly contributes to the growth and success of shrimp and fish farmers across India. We're not just building a company — we're building a brighter future for an entire industry." },
  { icon: Users,    title: 'Collaboration',body: 'Work alongside a diverse and passionate team dedicated to making a difference. Aqua Rudra fosters a culture of collaboration and learning, where your ideas and contributions are valued.' },
  { icon: BookOpen, title: 'Learning',    body: 'Aqua Rudra is dedicated to fostering a culture of perpetual learning and advancement. We offer extensive avenues for professional development, comprehensive training initiatives and direct access to leading industry authorities.' },
];
