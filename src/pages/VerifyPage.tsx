  ...
  return (
    <div className="min-h-screen bg-background text-white">
      ...
      <main className="container mx-auto px-6 lg:px-8 max-w-2xl pb-20">
        <div className="text-[11px] uppercase tracking-widest text-white/30 mb-2">Certificate</div>
        ...
        {result.state === 'loading' && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex items-center justify-center py-20 text-white/40 text-sm"
          >
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <div className="text-lg font-bold text-white">Signature does not match</div>
              </div>
            </div>
          ...
          >
            <div className="p-6 rounded-2xl border border-emerald-400/30 bg-emerald-500/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold text-white">Signature matches canonical record</div>
            ...
            <div className="p-5 rounded-2xl border border-white/10 bg-white/[0.03] space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-white">Certificate details</span>
                </div>
                <div
            ...
            <div className="pt-3 border-t border-white/5 flex items-center justify-between text-xs">
              ...
              <a
                ...
                className="text-white/40 hover:text-white inline-flex items-center gap-1"
              >
...
function Row({ k, v, icon: Icon }: { k: string; v: string; icon?: React.ElementType }) {
  return (
    <div className="flex items-baseline justify-between gap-2 py-1.5 px-2 rounded-md bg-white/[0.02]">
      ...
      <span className="text-white/90 truncate ml-2">{v}</span>
    </div>
  );
}
