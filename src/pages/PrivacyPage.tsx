    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-6 lg:px-8 pt-32 pb-20 max-w-3xl">
        ...
        <p className="text-foreground/80 mb-12 leading-relaxed">
          This Privacy Policy explains how Aqua AI (&ldquo;we&rdquo;, &ldquo;us&rdquo;) collects, uses
          and protects your information when you use the Aqua AI mobile app and the
        ...
        <div className="space-y-10 text-sm md:text-base leading-relaxed">
          <Section id="who" title="1. Who this policy applies to">
            <p>
              Anyone who downloads or uses the Aqua AI Android or iOS app, signs in
          ...
          <Section id="children" title="8. Children">
            <p>
              Aqua AI is intended for users aged 16 and above. We do not knowingly collect
