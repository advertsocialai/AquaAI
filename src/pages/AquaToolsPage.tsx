...
export default function AquaToolsPage() {
  useEffect(() => { document.title = 'Aqua Tools — Aqua Rudra'; }, []);
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-28 pb-20">
        <div className="container mx-auto px-6 lg:px-8 max-w-6xl">
          <div className="text-sm uppercase tracking-widest text-teal-300 mb-2">Aqua tools</div>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-2">Calculators</h1>
          <p className="text-sm md:text-base text-foreground/60 mb-8 max-w-2xl">
            Plan every pond — survival rate, daily feed &amp; FCR, aeration, stocking and profit, all on-device.
          </p>
          <CalculatorsModule />
        </div>
      </main>
