...
const FAQ = [
  { q: 'What is Aqua Rudra?',
    a: 'Aqua Rudra is a phone app that helps shrimp and prawn farmers check for disease, count seed, and watch water quality — right at the pond. It gives fast results so you can act early and protect your crop.' },
  { q: 'Is Aqua Rudra free to try?',
    a: 'You can start with a free trial. Pay only when you are ready.' },
  { q: 'Who is Aqua Rudra for?',
    a: 'It is made for coastal shrimp and prawn farmers — small and large. No technical background needed.' },
  { q: 'What phone do I need?',
    a: 'Any normal Android phone. No special or expensive device.' },
  { q: 'Does it work in my language?',
    a: 'Yes — you can use it in your local language.' },
  { q: 'Do I need training to use it?',
    a: 'No. Just tap and follow simple steps. Most tasks are "take a photo" or "enter a number."' },
  { q: 'Does it need fast internet?',
    a: 'No. The main checks work on slow signal or no signal. Your data syncs later when you are back online.' },
  { q: 'Who do I call if I get stuck?',
    a: 'Our support team helps you in your language.' },
  { q: 'How do I check for disease?',
    a: 'Take a clear photo of your shrimp or a sample. Aqua Rudra checks it and gives the result in seconds.' },
  { q: 'How does Aqua Rudra detect EHP and other diseases?',
    a: 'It looks at your photo for early signs of EHP, white gut, and white feces disease, then shows you the risk — no waiting for a lab report.' },
  { q: 'How accurate is the disease detection?',
    a: 'Aqua Rudra is trained on thousands of real pond images and flags risks reliably. It is a screening tool, so when it shows a warning, inspect closely and confirm.' },
  { q: 'Do I still need to send samples to a lab?',
    a: 'For daily checks, Aqua Rudra gives you a fast first result at the pond. For confirming a serious outbreak, a lab PCR test is still best. Think of Aqua Rudra as your early-warning system between lab visits.' },
  { q: 'How early can it catch a disease?',
    a: 'Very early — before the problem spreads across the pond. The earlier you catch it, the more of your crop you save.' },
  { q: 'Will it work for shrimp and prawn?',
    a: 'Yes — it covers vannamei shrimp, tiger prawn and scampi (freshwater prawn).' },
  { q: 'Can it count my seed (PL)?',
    a: 'Yes. Spread the post-larvae in a tray, take a photo, and Aqua Rudra counts them in seconds — so you pay only for what you actually receive.' },
  { q: 'What water quality does Aqua Rudra track?',
    a: 'It tracks key readings like pH, dissolved oxygen, ammonia, salinity, and temperature. The app shows the trend over time and warns you before a value gets dangerous.' },
  { q: 'Will it only tell me the problem, or also what to do?',
    a: 'Both. When it finds an issue, it gives a plain recommendation — for example, reduce feeding, check aeration, or isolate that pond — so you know your next step.' },
  { q: 'Can I track many ponds?',
    a: 'Yes. Add all your ponds in one account and track each one separately — disease checks, water readings, feed, and stocking.' },
  { q: 'Is my farm data safe and private?',
    a: 'Yes. Your farm data belongs to you. It is stored securely, and we never share your records with other farmers, buyers, or anyone without your permission.' },
  { q: 'Can I share a report?',
    a: 'Yes. You can export a simple report or share it directly with your technician or buyer — handy for getting advice or showing crop health.' },
];
