...
/**
 * "Install Aqua AI on your phone" prompt.
 *
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-sm font-semibold text-white">Install Aqua AI</h3>
            <button
              aria-label="Dismiss"
              onClick={dismiss}
          ...
          {mode === 'android' ? (
            <>
              <p className="text-xs text-white/65 mt-1 leading-relaxed">
                Add Aqua AI to your home screen for offline access, faster launch and push alerts.
              </p>
            ...
            <>
              <p className="text-xs text-white/65 mt-1 leading-relaxed">
                Get Aqua AI on your home screen — works offline and feels like a native app.
              </p>
