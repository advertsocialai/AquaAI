      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center gap-3">
            <img src={atomLogo} alt="Aqua AI" className="w-11 h-11 object-contain brightness-125 drop-shadow-[0_0_8px_rgba(56,189,248,0.4)]" />
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-white/45">New to Aqua AI</div>
                      </div>
                    </Link>
                    <Link
                      to="/login"
