...
-- Enums
CREATE TYPE user_role AS ENUM ('farmer', 'vle', 'hatchery_manager', 'farm_supervisor', 'govt_officer', 'admin');
...
CREATE TYPE quality_grade AS ENUM ('PREMIUM', 'GOOD', 'CONDITIONAL', 'CAUTION', 'REJECT');
CREATE TYPE subscription_plan AS ENUM ('basic', 'standard', 'premium');
CREATE TYPE plan_type AS ENUM ('farmer_monthly', 'farmer_annual', 'per_test', 'hatchery_basic', 'hatchery_standard', 'hatchery_premium', 'vle_franchise', 'insurance_api', 'govt_surveillance');
