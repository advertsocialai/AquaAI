  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-gradient": "linear-gradient(135deg, hsl(210, 100%, 50%) 0%, hsl(260, 70%, 50%) 100%)",
        "bio-gradient": "linear-gradient(135deg, hsl(200, 80%, 55%) 0%, hsl(210, 100%, 50%) 50%, hsl(260, 80%, 60%) 100%)",
      },
    },
  },
